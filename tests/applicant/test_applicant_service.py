...
async def test_create(sqlmodel_session: Session) -> None:
    ...
    created_applicant = await create(sqlmodel_session=sqlmodel_session, applicant=applicant)
...
async def test_retrieve_by_firstname(sqlmodel_session: Session, applicant: Applicant) -> None:
...
async def test_retrieve_by_lastname(sqlmodel_session: Session, applicant: Applicant) -> None:
...
async def test_retrieve_by_email(sqlmodel_session: Session, applicant: Applicant) -> None:
...
async def test_retrieve_by_phone(sqlmodel_session: Session, applicant: Applicant) -> None:
