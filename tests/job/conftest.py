...
@pytest.fixture
def make_job_without_observers(sqlmodel_session: Session, employee: Employee):
    def make(
        title="job title",
        description="job description",
        department="job department",
...
@pytest.fixture
def job_without_observers(make_job_without_observers):
    return make_job_without_observers()
